...
class BlogHolder_Controller extends BlogTree_Controller {
	...
	function BlogEntryForm() {	
		...
		if(BlogEntry::$allow_wysiwyg_editing) {
            ...
            Requirements::customScript("tinyMCE.init(ssTinyMceConfig);", "blog_post_tinyMCE_config"); // Force tinymce to init - otherwise Requirements::set_suffix_requirements() stops the init() call
		} else {
